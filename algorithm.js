...
let inputEntered = document.querySelector(".num");
let form = document.querySelector("#myForm");
let result = true;
form === null || form === void 0 ? void 0 : form.addEventListener('submit', function (event) {
    event.preventDefault();
    let enteredNumber = document.querySelector("#tcNum").value;
    let digits = enteredNumber.split("");
    let odds = 0;
    let evens = 0;
    let digitsTotal = 0;
    let numbers = /^[0-9]+$/;
    ...
    if (!enteredNumber.match(numbers)) {
        ...
        document.querySelector("#tcNum").value = "";
    }
    //console.log(digits);
